...
<div class="payedDiv">
	...
	<div class="payedAddressInfo">
		<ul>
			<li>收货地址：${o.information.address} ${o.information.receiver} ${o.information.mobile }</li>
	...
	<div class="warningDiv">
		...
		<b>安全提醒：</b>下单后，<span class="redColor boldWord">用QQ、微信等给您发送链接办理退款的都是骗子！</span>谨防假冒客服电话诈骗！
	</div>
