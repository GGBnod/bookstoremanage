...
<div class="reviewDiv">
	<div class="reviewProductInfoDiv">
		<div class="reviewProductInfoImg">
			<img width="400px" height="400px" src="img/book/${b.id}.jpg">
		</div>
		<div class="reviewProductInfoRightDiv">
			<div class="reviewProductInfoRightText">${b.name}</div>
			...
			<div class="reviewProductInfoRightBelowDiv">
				<span class="reviewProductInfoRightBelowImg">简介：${b.introduce}
				</span>
	...
	<div class="reviewStasticsDiv">
		<div class="reviewStasticsLeft">
			...
			<div class="reviewStasticsLeftContent">
				累计评价 <span class="reviewStasticsNumber"> ${b.reviewCount}</span>
			</div>
	...
	<c:if test="${param.showonly!=true}">
		<div class="makeReviewDiv">
			<form method="post" action="foredoreview">
				<div class="makeReviewText">书友们，需要你的建议哦！</div>
				...
				<div class="makeReviewButtonDiv">
					<input type="hidden" name="oid" value="${o.id}"> <input
						type="hidden" name="bid" value="${b.id}">
