...
<div class="confirmPayPageDiv">
	...
	<div class="confirmPayOrderItemDiv">
		...
		<table class="confirmPayOrderItemTable">
			...
			<c:forEach items="${o.orderItems}" var="oi">
				<tr>
					<td><img width="50px" src="img/book/${oi.book.id}.jpg"></td>
					<td class="confirmPayOrderItemProductLink">
						<a href="#nowhere">${oi.book.name}</a>
					</td>
					<td>￥<fmt:formatNumber type="number" value="${oi.book.price}" minFractionDigits="2"/></td>
					<td><fmt:formatNumber type="number" value="${oi.number}" /></td>
					<td><span class="conformPayProductPrice">￥<fmt:formatNumber type="number" value="${oi.book.price}" minFractionDigits="2"/></span></td>
	...
	<div class="confirmPayOrderDetailDiv">
		...
		<table class="confirmPayOrderDetailTable">
			...
			<tr>
				<td>收货信息： </td>
				<td>${o.information.address}，${o.information.receiver}， ${o.information.mobile}，${o.information.post} </td>
			</tr>
			<tr>
				<td>成交时间：</td>
